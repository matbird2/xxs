 ...
 */
public class WatchViewpagerAdapterBak extends FragmentPagerAdapter {
    private ArrayList<Fragment> fragments = new ArrayList<Fragment>();
    ;
    private final FragmentManager fm;

    public WatchViewpagerAdapterBak(FragmentManager fm) {
        super(fm);
        this.fm = fm;
    }

    public WatchViewpagerAdapterBak(FragmentManager fm, ArrayList<Fragment> fragments) {
        super(fm);
        this.fm = fm;
